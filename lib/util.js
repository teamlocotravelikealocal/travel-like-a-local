...
exports.getEventsFromEventbrite = function(req, res) {
  ...
  var lattitude = req.params.lattitude;
  var longitude = req.params.longitude;

  let options = {
    url: `https://www.eventbriteapi.com/v3/events/search/?token=${EVENTBRITE_API_KEY}&q=music&location.within=20mi&location.latitude=${lattitude}&location.longitude=${longitude}`,
    json:true,
    headers: {
      'User-Agent': 'request',
      "Content-Type": "application/json",
